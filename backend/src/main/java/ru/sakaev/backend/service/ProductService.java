package ru.sakaev.backend.service; // Объявление пакета для класса ProductService
...
import ru.sakaev.backend.observer.ProductQuantityPublisher;
import ru.sakaev.backend.publisher.Publisher;
import ru.sakaev.backend.repositories.ProductRepository; // Импорт интерфейса ProductRepository
