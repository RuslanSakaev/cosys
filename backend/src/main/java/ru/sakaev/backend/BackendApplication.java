package ru.sakaev.backend; // Объявление пакета для класса BackEndAppApplication
...
public class BackendApplication implements WebMvcConfigurer { // Объявление класса BackEndAppApplication, реализующего интерфейс WebMvcConfigurer

	public static void main(String[] args) { // Метод main, точка входа в приложение
		SpringApplication.run(BackendApplication.class, args); // Запуск приложения Spring Boot
	}
